...
const SignUpComponent = () => {
    ...
    return (
        <div
            className={`min-h-[calc(100vh-421px)] flex items-center justify-center py-12 pt-32 px-4 sm:px-6 lg:px-8 transition-colors duration-300 ${
            ...
            <div className={`max-w-xl w-full space-y-8 relative ${
                ...
                {/* Decorative Elements */}
                <div
                    className="absolute -top-10 -right-10 w-40 h-40 bg-gradient-to-br from-purple-600/20 to-pink-600/20 rounded-full blur-3xl -z-10"></div>
                <div
                    className="absolute -bottom-10 -left-10 w-40 h-40 bg-gradient-to-br from-blue-600/20 to-cyan-600/20 rounded-full blur-3xl -z-10"></div>
                            ...
                            <div className="flex items-center h-5">
                                <input
                                    ...
                                    className={`h-4 w-4 rounded ${
                                        darkMode
                                            ? 'bg-gray-700 border-gray-600 text-purple-600 focus:ring-purple-500/50'
                                            : 'bg-white border-gray-300 text-indigo-600 focus:ring-indigo-500/50'
                                    } transition-colors duration-300`}
                                />
                            </div>
