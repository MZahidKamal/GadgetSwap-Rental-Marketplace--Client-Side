    ...
    return (
        ...
        >
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                ...
                ></div>
                <div
                    className={`absolute top-1/2 -left-24 w-64 h-64 rounded-full opacity-10 ${
                        darkMode ? "bg-blue-600" : "bg-blue-400"
                    }`}
                ></div>
                <div
                    className={`absolute -bottom-32 right-1/4 w-80 h-80 rounded-full opacity-10 ${
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            {footerLinks.map((section) => (
                                <div key={section.id} className="space-y-4">
                                    ...
                                    <ul
                                        className={`space-y-3 ${
                                            activeSection === section.id || window.innerWidth >= 1024 ? "block" : "hidden lg:block"
                                        }`}
                                    >
                                            ...
                                            <li key={linkIndex}>
                                                ...
                                                >
                                                    <span className={`mr-2 transition-colors ${
                                                        darkMode ? "text-purple-500 group-hover:text-purple-400" : "text-indigo-500 group-hover:text-indigo-600"
                                                    }`}>
                                                        {link.icon}
                                                    </span>
